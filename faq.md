...
For more information on how Uptane can interact with other mechanisms, go to the [Customizing Uptane](https://github.com/uptane/deployment-considerations/blob/master/customizations.md) section. 
